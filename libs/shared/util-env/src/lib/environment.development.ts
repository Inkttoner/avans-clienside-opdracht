...
export const environment: IEnvironment = {
    ...
    MONGO_DB_CONNECTION_STRING: 'mongodb+srv://kruijfcoen:Me7fJczyU5Slejpt@trinitas-avans.vnzbm.mongodb.net/?retryWrites=true&w=majority&appName=Trinitas-Avans',
    NEO4J_USER: 'neo4j',
